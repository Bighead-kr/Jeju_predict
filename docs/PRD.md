...
| 데이터 기간     | 2023-02-03 00:00 ~ 2026-06-03 (시간 단위, 29,185행) |
...
| • 필요 기간: 2023-02-03 ~ 2026-06-03 (기상 데이터와 동일 기간)            |
...
- **Train / Val / Test 분할**: 2023.02~2025.06 학습 | 2025.07~2025.12 검증 | 2026.01~2026.06 테스트
...
\- 기간: 2023-02-03 00:00 ~ 2026-06-03 (시간 단위, ~29185행)
...
| • 필요 컬럼: timestamp \| solar_mw \| wind_mw (2023.02 ~ 2026.06)                |
...
→ 권장: FAISS (Colab에서 바로 쓸 수 있고 29,185행 규모에 충분)
